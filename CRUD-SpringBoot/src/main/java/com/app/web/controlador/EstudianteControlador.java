...
import org.springframework.web.bind.annotation.PostMapping; // Agregado para manejar la solicitud POST
...
public class EstudianteControlador {
    ...
    @PostMapping("/estudiantes") // Cambiado a @PostMapping para manejar la solicitud POST
   
    public String guardarEstudiante(@ModelAttribute("estudiante") Estudiante nuevoEstudiante) {
        try {
            servicio.guardarEstudiante(nuevoEstudiante);
        } catch (Exception e) {
